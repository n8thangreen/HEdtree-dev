##' Facilitates generating a PSA data.table object from a parameter object
##'
##' @param N number of samples (rows)
##' @param P parameter object (eg from parse.parmtable)
##' @param dbls list of 2-D named vectors for any parameter pairs generated
##'             jointly (same order as in \code{P})
